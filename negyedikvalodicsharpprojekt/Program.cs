...
namespace ElsoValodiCharpProjekt
{
    class Program
    {
        ...
        static bool primszamE(int szam)
        {
            ...
            /*34.feladat: 2019.11.19.
            Console.WriteLine("A páros speciális számok");
            ...
            Console.ReadKey(true);*/
            /*36.Feladat:
            Console.Write("Kérem a sorok számat");
            int sorok = Int32.Parse(Console.ReadLine());
            Console.Write("Kérem az oszlopok szamat");
            ...
            Console.ReadKey(true);*/
            /*37.Feladat
            Console.Write("Kérem a sorok szamat");
            int a = Convert.ToInt32(Console.ReadLine());
            for (int i = 0; i < a; i++)
            {
